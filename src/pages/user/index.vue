<template>
  <view class="mine-container" :style="{height: `${windowHeight}px`,paddingTop:`${safetyTop}px`}">
...
<style lang="scss">
  .mine-container {
    ...
    background-image: linear-gradient(180deg, rgb(214, 227, 245) 0%, rgb(255, 255, 255) 100%);
    .header-title {
      font-size: 36rpx;
      color: #252525;
      height: 80rpx;
